...
# === CONFIGURAÇÕES ===
pasta_entrada = "imagens_pdf/temp"     # onde estão as imagens dos cartões
pasta_saida = "imagens_pdf/result"             # onde salvar as imagens processadas

# cria a pasta de saída caso não exista
os.makedirs(pasta_saida, exist_ok=True)

# gabarito esperado (ajuste conforme sua prova)
gabarito_correto = [
    'A', 'C', 'C', 'D', 'C','D', 'A', 'B', 'E', 'C',
    'B', 'C', 'D', 'C', 'D','E', 'C', 'C', 'B', 'A'
]
...
# === LOOP PRINCIPAL: processa todos os cartões ===
for arquivo in os.listdir(pasta_entrada):
    if arquivo.lower().endswith((".png", ".jpg", ".jpeg")):
        caminho_img = os.path.join(pasta_entrada, arquivo)
        processar_cartao(caminho_img, gabarito_correto, pasta_saida)

print("\n🏁 FIM: Todas as imagens foram processadas e salvas em", pasta_saida)
